...
To run this project on your local machine, you will need a C++17 compatible compiler (like GCC or Clang) with POSIX thread support.

### 1. Clone the repository:

```bash
git clone https://github.com/sathvikredyy77/ThreadSafe-VFS.git
cd ThreadSafe-VFS
```
...
```bash
g++ -std=c++17 -pthread main.cpp -o vfs_simulator
```
